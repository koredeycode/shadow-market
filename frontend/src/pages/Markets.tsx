      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-white/5 pb-8">
        <div className="space-y-2">
          ...
          <p className="text-slate-500 font-light">
            Real-time prediction markets across all categories.
          </p>
        </div>
        ...
        <div className="flex items-center gap-4">
          {isConnected && (
            <Link
              to="/markets/create"
              className="px-6 py-2 bg-electric-blue text-white rounded-sm font-bold text-[10px] tracking-[0.2em] uppercase hover:brightness-110 transition-all flex items-center gap-2 shadow-[0_0_20px_rgba(59,130,246,0.3)]"
            >
              <Zap className="w-3.5 h-3.5" />
              Launch Market
            </Link>
          )}
          <div className="flex items-center gap-4 bg-white/5 p-1 rounded-sm border border-white/10 h-10">
            <button className="px-3 py-1.5 bg-white/5 text-slate-400 hover:text-white rounded-sm text-xs font-bold transition-all">
