      ...
      <div className="p-5 flex-1">
        <div className="flex justify-between items-start mb-4">
          <div className="flex flex-col gap-1.5">
            ...
            <span
              className={`text-[8px] font-mono font-bold uppercase tracking-widest px-2 py-0.5 rounded-sm border w-fit ${
                market.status === 'OPEN'
          ...
          <div
            className={`flex items-center gap-1 text-[10px] font-mono font-bold uppercase transition-colors ${sentimentColor}`}
          >
      ...
      <div className="mt-auto border-t border-white/5 bg-black/20 p-4">
        <div className="flex items-center gap-2 mb-4">
          <div className="flex-1 bg-slate-950 border border-white/10 p-2 rounded-sm flex flex-col items-center">
            ...
            <span className="text-sm font-mono font-bold text-success-green">
              {yesPriceNum.toFixed(0)}%
            </span>
          </div>
          <div className="flex-1 bg-slate-950 border border-white/10 p-2 rounded-sm flex flex-col items-center">
