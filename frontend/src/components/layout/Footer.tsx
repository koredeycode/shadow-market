      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="space-y-2">
          <Link to="/" className="flex items-center gap-2 group w-fit">
            ...
            <span className="text-xl font-bold tracking-tight text-white focus:outline-none">Shadow Market</span>
          </Link>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 pt-4">
          <div className="col-span-2 md:col-span-2 hidden lg:block" /> {/* Placeholder for category space if needed later */}
          
          <div className="space-y-4">
            <h4 className="text-[10px] font-mono font-bold text-slate-500 uppercase tracking-[0.2em]">Support & Social</h4>
          ...
          <div className="space-y-4">
            <h4 className="text-[10px] font-mono font-bold text-slate-500 uppercase tracking-[0.2em]">Shadow Market</h4>
            <ul className="space-y-2">
        ...
        <div className="pt-12 border-t border-white/5 space-y-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-5">
              ...
              <a href="#" className="text-slate-500 hover:text-white transition-colors"><X className="w-5 h-5" /></a>
              <a href="#" className="text-slate-500 hover:text-white transition-colors"><Camera className="w-5 h-5" /></a>
              <a href="#" className="text-slate-500 hover:text-white transition-colors"><MessageSquare className="w-5 h-5" /></a>
              <a href="#" className="text-slate-500 hover:text-white transition-colors"><Music2 className="w-5 h-5" /></a>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 text-[11px] text-slate-500 font-mono uppercase tracking-wider">
              ...
              <span className="hidden md:inline opacity-20 text-slate-500">•</span>
              <Link to="/integrity" className="hover:text-white transition-colors">Market Integrity</Link>
              <span className="hidden md:inline opacity-20 text-slate-500">•</span>
            ...
            <div className="flex items-center gap-2 px-3 py-1.5 bg-white/5 border border-white/10 rounded-sm hover:border-white/20 transition-all cursor-pointer group">
              ...
              <span className="text-[10px] font-mono font-bold text-slate-400 uppercase tracking-widest">English</span>
          ...
          <p className="text-[10px] text-slate-600 font-light leading-relaxed max-w-5xl">
            Shadow Market operates globally through decentralized smart contracts. Shadow Market US is operated by QCX LLC d/b/a Shadow Market US, a CFTC-regulated Designated Contract Market. This platform utilizes Midnight ZK-technology for transaction privacy. Trading involves substantial risk of loss. Always review our <Link to="/terms" className="text-slate-500 hover:underline">Terms of Service</Link> and <Link to="/privacy" className="text-slate-500 hover:underline">Privacy Policy</Link> before participating.
          </p>
        </div>
      </div>
    </footer>
