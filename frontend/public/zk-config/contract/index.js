...
export class Contract {
  ...
  _placeBet_0(context, partialProofData, marketId_0, side_0) {
    ...
    const currentNo_0 = _descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                  ...
                                                                                  [
                                                                                   ...
                                                                                   { popeq: { cached: false,
                                                                                              result: undefined } }]).value);
    const newYes_0 = __compactRuntime.addField(currentYes_0,
                                               __compactRuntime.mulField(disclosedSide_0,
                                                                         amount_0));
    const newNo_0 = __compactRuntime.addField(currentNo_0,
                                              __compactRuntime.mulField(__compactRuntime.subField(1n,
                                                                                                  disclosedSide_0),
                                                                        amount_0));
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
  ...
  _claimPoolWinnings_0(context, partialProofData, betId_0) {
    ...
    const storedUserKey_0 = _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
                                                                                       { idx: { cached: false,
    ...
    const marketId_0 = _descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                 ...
                                                                                 [
                                                                                  ...
                                                                                  { popeq: { cached: false,
                                                                                             result: undefined } }]).value);
    const outcome_0 = _descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                partialProofData,
                                                                                [
                                                                                 { dup: { n: 0 } },
                                                                                 { idx: { cached: false,
    ...
    const yesTotal_0 = _descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                 partialProofData,
                                                                                 [
                                                                                  { dup: { n: 0 } },
                                                                                  { idx: { cached: false,
                                                                                  ...
                                                                                  { popeq: { cached: false,
                                                                                             result: undefined } }]).value);
    const noTotal_0 = _descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                partialProofData,
                                                                                [
                                                                                 { dup: { n: 0 } },
                                                                                 { idx: { cached: false,
                                                                                 ...
                                                                                 { popeq: { cached: false,
                                                                                            result: undefined } }]).value);
    const winningPool_0 = __compactRuntime.addField(__compactRuntime.mulField(outcome_0,
                                                                              yesTotal_0),
                                                    __compactRuntime.mulField(__compactRuntime.subField(1n,
                                                                                                        outcome_0),
                                                                              noTotal_0));
    const losingPool_0 = __compactRuntime.addField(__compactRuntime.mulField(__compactRuntime.subField(1n,
                                                                                                       outcome_0),
                                                                             yesTotal_0),
                                                   __compactRuntime.mulField(outcome_0,
                                                                             noTotal_0));
    const tmp_0 = 1n;
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
  ...
  _claimWagerWinnings_0(context, partialProofData, wagerId_0) {
    ...
    const outcome_0 = _descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                ...
                                                                                [
                                                                                 ...
                                                                                 { popeq: { cached: false,
                                                                                            result: undefined } }]).value);
    const betSide_0 = _descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                partialProofData,
                                                                                [
                                                                                 { dup: { n: 0 } },
                                                                                 { idx: { cached: false,
                                                                                 ...
                                                                                 { popeq: { cached: false,
                                                                                            result: undefined } }]).value);
    const creatorAmount_0 = _descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
                                                                                       { idx: { cached: false,
                                                                                       ...
                                                                                       { popeq: { cached: false,
                                                                                                  result: undefined } }]).value);
    const takerAmount_0 = _descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                    partialProofData,
                                                                                    [
                                                                                     { dup: { n: 0 } },
                                                                                     { idx: { cached: false,
      ...
      member(...args_0) {
        ...
        if (!(typeof(key_0) === 'bigint' && key_0 >= 0 && key_0 <= __compactRuntime.MAX_FIELD)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'shadow-market.compact line 30 char 1',
                                     'Field',
                                     key_0)
        }
        return _descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    marketStatus: {
      ...
      member(...args_0) {
        ...
        if (!(typeof(key_0) === 'bigint' && key_0 >= 0 && key_0 <= __compactRuntime.MAX_FIELD)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'shadow-market.compact line 31 char 1',
                                     'Field',
                                     key_0)
        }
        return _descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    marketEndTime: {
      ...
      member(...args_0) {
        ...
        if (!(typeof(key_0) === 'bigint' && key_0 >= 0 && key_0 <= __compactRuntime.MAX_FIELD)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'shadow-market.compact line 32 char 1',
                                     'Field',
                                     key_0)
        }
        return _descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    marketOutcome: {
      ...
      member(...args_0) {
        ...
        if (!(typeof(key_0) === 'bigint' && key_0 >= 0 && key_0 <= __compactRuntime.MAX_FIELD)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'shadow-market.compact line 33 char 1',
                                     'Field',
                                     key_0)
        }
        return _descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    marketTitle: {
      ...
      member(...args_0) {
        ...
        if (!(typeof(key_0) === 'bigint' && key_0 >= 0 && key_0 <= __compactRuntime.MAX_FIELD)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'shadow-market.compact line 34 char 1',
                                     'Field',
                                     key_0)
        }
        return _descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
