...
DO $$ BEGIN
 CREATE TYPE "market_status" AS ENUM('PENDING', 'OPEN', 'LOCKED', 'RESOLVED', 'CANCELLED');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "wager_status" AS ENUM('OPEN', 'MATCHED', 'RESOLVED', 'CANCELLED');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "markets" (
	...
	"min_bet" numeric(20, 0) NOT NULL,
	"max_bet" numeric(20, 0) NOT NULL,
	"total_volume" numeric(20, 0) DEFAULT '0' NOT NULL,
	"total_liquidity" numeric(20, 0) DEFAULT '0' NOT NULL,
...
CREATE INDEX IF NOT EXISTS "positions_user_idx" ON "positions" ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "positions_market_idx" ON "positions" ("market_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "positions_settled_idx" ON "positions" ("is_settled");--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "positions" ADD CONSTRAINT "positions_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "positions" ADD CONSTRAINT "positions_market_id_markets_id_fk" FOREIGN KEY ("market_id") REFERENCES "markets"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
